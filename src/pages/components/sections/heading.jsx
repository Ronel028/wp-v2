      ...
      <div className=" max-w-[1206px] w-[90%] mx-auto ">
        ...
        <section className=" mt-[154px]">
          <div className=" max-w-[681px] ml-[108px]">
            ...
            <Link
              href="/"
              className={`animate__animated animate__fadeInDownBig animate__delay-2s tracking-wider mb-6 py-2 px-4 inline-flex items-center gap-2 bg-indigo-500 text-white text-sm font-semibold rounded-md shadow-lg shadow-indigo-500/50 focus:outline-none ${SourceSansProBold.className}`}
            >
