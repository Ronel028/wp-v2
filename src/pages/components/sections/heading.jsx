...
const Headings = () =>{
    return (
        <main className={` min-h-screen relative h-auto bg-home-background bg-cover bg-center `}>
            <div className=" max-w-[1206px] w-[90%] mx-auto ">
                ...
                <div className=" max-w-[681px] ml-[108px]">
                    <p className={`animate__animated animate__fadeInDownBig animate__delay-4s tracking-wide mb-6 inline-flex items-center gap-1 bg-[#C63D56] py-[11px] px-[16px] rounded-lg ${SourceSansProBold.className}`}>
                        <Image
                        src={handIcon}
                        width={20}
                        height={20}
                    ...
                    <h1 className={`animate__animated animate__fadeInDownBig animate__delay-3s text-[2.5rem] tracking-wider mb-6 leading-[3rem]`}>
                    ...
                    <Link href='/' className={`animate__animated animate__fadeInDownBig animate__delay-2s tracking-wider mb-6 py-2 px-4 inline-flex items-center gap-2 bg-indigo-500 text-white text-sm font-semibold rounded-md shadow-lg shadow-indigo-500/50 focus:outline-none ${SourceSansProBold.className}`}>
                        <i class="fa-solid fa-folder-open text-sm"></i> Projects
                    </Link>
                    <div className=" flex items-center gap-6 animate__animated animate__fadeInDownBig">
